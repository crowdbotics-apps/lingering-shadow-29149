...
## Project Structure
    ...
    ├── lingering_shadow_29149  # Django project configurations
...
1. Clone this repo and `cd lingering_shadow_29149`
...
2. Clone this repo and `cd lingering_shadow_29149`
